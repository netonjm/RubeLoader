...
namespace CocosSharp.RubeLoader
{
    ...
    public class RubeBasicLayer : CCLayer
    {
        ...
        {
            CCPoint screenPos = touch.LocationInView;
        ...
        public CCPoint WorldToScreen(b2Vec2 worldPos)
        {
            ...
            return WorldToScreen(worldPos, Position, ScaleX, Director.WindowSizeInPixels);
        }

        public b2Vec2 ScreenToWorld(CCPoint screenPos)
        {
            return ScreenToWorld(screenPos, Position, ScaleX, Director.WindowSizeInPixels);
        }
